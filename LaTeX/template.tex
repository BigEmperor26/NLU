...
\begin{table*}[h]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{l|ccc}
			...
			%	Baseline &  \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth, height=60mm]{../assets/CM_baseline_intent_ATIS}} & \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth, height=60mm]{../assets/CM_baseline_intent_remix_ATIS}} & \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth, height=60mm]{../assets/CM_baseline_intent_SNIPS}}\\
		\end{tabular}
	\end{adjustbox}
...
%		\centering
%		\includegraphics[width=\textwidth]{../assets/BiLSTM_joint_loss_ATIS.png}
